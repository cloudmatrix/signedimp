...
class MD5Type:
    ...
    def digest(self):
        ...
        digest_parts = []
        for val in (self.A,self.B,self.C,self.D):
            digest_parts.append(chr((val & 0x000000FF)))
            digest_parts.append(chr((val & 0x0000FF00) >> 8))
            digest_parts.append(chr((val & 0x00FF0000) >> 16))
            digest_parts.append(chr((val & 0xFF000000) >> 24))
